...
const AddToy = () => {
    ...
    const onSubmit = data => {
        ...
        fetch(`${import.meta.env.VITE_BASE_URL}/addtoy`, {
            method: 'POST',
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="m-auto my-10 max-w-lg">
                ...
                <button className="btn block font-bold w-full bg-[#5140e9] hover:bg-[#1223d6] border-none rounded-md text-white">Add Toy</button>
            </form>
